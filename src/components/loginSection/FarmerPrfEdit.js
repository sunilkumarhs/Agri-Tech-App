          ...
          <div key={farm.id}>
            ...
            <div className="mt-1 sm:mt-6 flex items-center justify-end gap-x-6">
              ...
              <button
                ...
                type="submit"
                className="rounded-md px-1 py-1 sm:px-3 sm:py-2 text-l leading-2 sm:leading-6 sm:text-xl bg-blue-700 font-bold text-white hover:bg-green-600 shadow-sm ring-1 ring-inset ring-gray-300"
                // onClick={() => {
