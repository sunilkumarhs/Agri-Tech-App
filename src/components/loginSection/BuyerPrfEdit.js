      ...
      >
              ...
              <div className=" col-span-1 sm:col-span-1">
                ...
                <div className="mt-0 sm:mt-2">
                  <input
                    id="district"
                    name="district"
                    className={`block w-full rounded-md border px-1 sm:px-1.5 sm:py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 text-sm leading-2 sm:max-w-xs sm:text-xl sm:leading-8`}
                    disabled
        ...
        <div className="mt-1 sm:mt-6 flex items-center justify-end gap-x-6">
          ...
          <button
            ...
            type="submit"
            className="rounded-md px-1 py-1 sm:px-3 sm:py-2 text-l leading-2 sm:text-xl sm:leading-6 bg-blue-700 font-bold text-white hover:bg-green-600 shadow-sm ring-1 ring-inset ring-gray-300"
          >
            Submit
          </button>
        </div>
