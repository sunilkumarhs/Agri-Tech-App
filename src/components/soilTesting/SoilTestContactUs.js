...
const SoilTestContactUs = () => {
  ...
  return (
    <div className="w-full">
      ...
      >
        <label className="flex-1 font-poppins font-bold sm:text-5xl text-l mt-0 sm:mt-2 text-yellow-500 leading-8 sm:leading-16">
          Contact Us
        </label>
      </div>
      {/* contac */}
      <div
        className={`flex-1 ${styles.flexCenter} flex-col xl:px-0 sm:px-10 px-1 py-0 sm:py-1 bg-dimBlue`}
      >
        <div className="mx-auto mt-1 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-1 lg:flex-auto">
...
export default SoilTestContactUs;
