...
const SoilTestReport = () => {
  ...
  const {
    ...
    onSubmit: async (values, actions) => {
      ...
      alert("Wrong-Id Please check Id!!");
      actions.resetForm();
    },
  });
  return (
      ...
      <div className={`${styles.flexStart} soilReportContainer`}>
        <div className={`${styles.boxWidth}`}>
          <section className={`flex flex-col ${styles.paddingY} pb-10`}>
            <div className={`flex-1 ${styles.flexCenter} flex-col py-2`}>
              <div className="mx-auto mt-1 sm:mt-3 max-w-4xl rounded-2xl border border-white lg:mx-0 lg:flex lg:max-w-none text-center">
                <div className="p-2 sm:p-5 lg:flex-auto">
                  <h3 className="text-2xl mb-1 font-bold tracking-tight text-yellow-500 sm:text-5xl sm:pb-5 backdrop-blur-sm">
